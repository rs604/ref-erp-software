...
(function () {
  ...
  var MENU = [
    ...
    { label: 'Busy Data', icon: 'database', children: [
      ...
      { label: 'Debtors',        page: 'busy.html', view: 'debtors',  firm: 'REF', perm: 'busy_data.view' },
      { label: 'Creditors',      page: 'busy.html', view: 'creditors',firm: 'REF', perm: 'busy_data.view' },
      { label: 'Items',          page: 'busy.html', view: 'items',    firm: 'REF', perm: 'busy_data.view' },
      ...
      { label: 'Debtors',        page: 'busy.html', view: 'debtors',  firm: 'RS', perm: 'busy_data.view' },
      { label: 'Creditors',      page: 'busy.html', view: 'creditors',firm: 'RS', perm: 'busy_data.view' },
      { label: 'Items',          page: 'busy.html', view: 'items',    firm: 'RS', perm: 'busy_data.view' },
